...
public class MainActivity extends AppCompatActivity {
    ...
    public void startScrool(Integer num) {
        ...
        if (length == 1) {
            ...
            Log.e("TAG","first : "+firstNum);
            mixWheel(R.id.dialog_slot_2, 70 + firstNum, 5000);
            ...
            int firstNum = Integer.parseInt(String.valueOf(c));
            Log.e("TAG","first : "+firstNum);
            mixWheel(R.id.dialog_slot_1, 50 + firstNum, 3000);
            char c1 = numString.charAt(1);
            int secondNum = Integer.parseInt(String.valueOf(c1));
            mixWheel(R.id.dialog_slot_2, 70 + secondNum, 5000);
